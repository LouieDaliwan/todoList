    ...
    onSubmitHandler = (e) => {
        ...
        .then((result) => {
            ...
            if(result.status === "error" && result.validation_errors.last_name) {
                this.setState({
                    error: true,
                    errMsgFirstName: result.validation_errors.last_name[0]
                })
            }
            ...
            if(result.status === "error" && result.validation_errors.email) {
                this.setState({
                    error: true,
                    errMsgFirstName: result.validation_errors.email[0]
                })
            }
            ...
            if(result.status === "error" && result.validation_errors.phone) {
                this.setState({
                    error: true,
                    errMsgFirstName: result.validation_errors.phone[0]
                })
            }
            ...
            if(result.status === "error" && result.validation_errors.password) {
                this.setState({
                    error: true,
                    errMsgFirstName: result.validation_errors.password[0]
                })
            }
        })
        .catch((error) => {
